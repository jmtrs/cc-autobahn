...
- [x] Current quality gate: 143 Rust tests, 59 frontend tests, 45 visual baselines,
...
```bash
npm run build
npm run test:frontend # 59 tests
npm run test:visual              # 36 page/theme/mode screens + 9 state snapshots
