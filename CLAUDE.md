...
Frontend: `npm run test:frontend` (59 tests, `node --test`) and `npm run test:visual` (45 pixel-compared Playwright baselines); no linter is configured yet.
